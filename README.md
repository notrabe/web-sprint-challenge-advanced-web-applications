...
Validation during log in and registration.
2. What steps can you take in your web apps to keep your data secure?
Back up your data, scan your website for vulnerabilities, keep everything up to date, have people try to 'attack' it.
3. Describe how web servers work.
Web servers use HTTP to store, process and deilver web pages to clients.
